...
#define FFMPEG_CONFIGURATION "--logfile=conflog.txt --target-os=linux --prefix=./libs/armeabi --arch=arm --enable-small --enable-cross-compile --extra-libs=-lgcc --cc=/opt/ndk/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-gcc --cross-prefix=/opt/ndk/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi- --nm=/opt/ndk/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-nm --extra-cflags=-I../x264/libs/arm/include --extra-cflags='-O3 -fpic -fasm -Wno-psabi -fno-short-enums -fno-strict-aliasing -finline-limit=300 -mfloat-abi=softfp -mfpu=vfp -marm -march=armv6 ' --extra-ldflags='-lx264 -Wl,-rpath-link=/usr/lib -L/usr/lib -nostdlib -lc -lm -ldl -llog ' --enable-neon --extra-ldflags=-L../x264/libs/arm/lib --sysroot=/opt/ndk/platforms/android-18/arch-arm/ --enable-shared --disable-static --enable-zlib --disable-doc --enable-gpl --enable-libx264"
#define FFMPEG_LICENSE "GPL version 2 or later"
#define CONFIG_THIS_YEAR 2017
#define FFMPEG_DATADIR "./libs/armeabi/share/ffmpeg"
#define AVCONV_DATADIR "./libs/armeabi/share/ffmpeg"
